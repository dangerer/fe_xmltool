...
$TCA['tx_exabiscompetences_descriptors'] = array (
	...
	'columns' => array (
		...
		'parent_id' => array (		
			'exclude' => 0,		
			'label' => 'LLL:EXT:exabis_competences/locallang_db.xml:tx_exabiscompetences_descriptors.parent_id',		
			'config' => array (
				'type' => 'select',	
				'items' => array (
					array('',0),
	...
	'types' => array (
		'0' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, fe_group, title;;;;2-2-2, topicid;;;;3-3-3,parent_id, niveauid, skillid')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
	...
	'columns' => array (
		...
		'l10n_parent' => array (		
			...
			'config'      => array (
				...
				'foreign_table'       => 'tx_exabiscompetences_niveau_texte',
				'foreign_table_where' => 'AND tx_exabiscompetences_niveau_texte.pid=###CURRENT_PID### AND tx_exabiscompetences_niveau_texte.sys_language_uid IN (-1,0)',
			)
		),
		'l10n_diffsource' => array (		
			'config' => array (
...
$TCA['tx_exabiscompetences_desp_lang'] = array (
	'ctrl' => $TCA['tx_exabiscompetences_desp_lang']['ctrl'],
	'interface' => array (
		'showRecordFieldList' => 'sys_language_uid,l10n_parent,l10n_diffsource,title'
	),
	'feInterface' => $TCA['tx_exabiscompetences_desp_lang']['feInterface'],
	'columns' => array (
		'sys_language_uid' => array (		
			'exclude' => 1,
			'label'  => 'LLL:EXT:lang/locallang_general.xml:LGL.language',
		...
		'l10n_parent' => array (		
			...
			'config'      => array (
				...
				'foreign_table'       => 'tx_exabiscompetences_desp_lang',
				'foreign_table_where' => 'AND tx_exabiscompetences_desp_lang.pid=###CURRENT_PID### AND tx_exabiscompetences_desp_lang.sys_language_uid IN (-1,0)',
			)
		),
		'l10n_diffsource' => array (		
			'config' => array (
		...
		'title' => array (		
			'exclude' => 0,		
			'label' => 'LLL:EXT:exabis_competences/locallang_db.xml:tx_exabiscompetences_desp_lang.title',		
			'config' => array (
				'type' => 'input',	
				'size' => '48',	
				'eval' => 'required,trim',
