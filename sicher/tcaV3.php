	...
	'columns' => array (
		...
		'solution' => array (		
			...
			'config' => array (
				'type' => 'group',
				'internal_type' => 'file',
				'allowed' => 'gif,png,jpeg,jpg,pdf,doc,docx,xls,xlsx,ppt,pptx',	
				'max_size' => $GLOBALS['TYPO3_CONF_VARS']['BE']['maxFileSize'],	
				'uploadfolder' => 'uploads/tx_exabiscompetences',
				'size' => 1,	
				'minitems' => 0,
...
$TCA['tx_exabiscompetences_niveaus'] = array (
	...
	'columns' => array (
		...
		'levelcode' => array (		
			'exclude' => 0,		
			'label' => 'LLL:EXT:exabis_competences/locallang_db.xml:tx_exabiscompetences_niveaus.levelcode',		
			'config' => array (
				'type' => 'input',	
				'size' => '4',
			)
		...
		'skillid' => array (		
			'exclude' => 0,		
			'label' => 'LLL:EXT:exabis_competences/locallang_db.xml:tx_exabiscompetences_niveaus.skillid',		
			'config' => array (
				'type' => 'select',	
				'items' => array (
					array('',0),
	...
	'types' => array (
		'0' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, levelcode;;;;2-2-2, skillid;;;;2-2-2, parent_niveau;;;;2-2-2, title;;;;3-3-3')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
