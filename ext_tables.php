...
t3lib_extMgm::allowTableOnStandardPages('tx_exabiscompetences_niveau_texte');


t3lib_extMgm::addToInsertRecords('tx_exabiscompetences_niveau_texte');

$TCA['tx_exabiscompetences_niveau_texte'] = array (
	'ctrl' => array (
		'title'     => 'LLL:EXT:exabis_competences/locallang_db.xml:tx_exabiscompetences_niveau_texte',		
		'label'     => 'title',	
		'tstamp'    => 'tstamp',
		'crdate'    => 'crdate',
		'cruser_id' => 'cruser_id',
		...
		'sortby' => 'sorting',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_exabiscompetences_niveau_texte.gif',
	),
);
...
t3lib_extMgm::allowTableOnStandardPages('tx_exabiscompetences_desp_lang');

$TCA['tx_exabiscompetences_desp_lang'] = array (
	'ctrl' => array (
		'title'     => 'LLL:EXT:exabis_competences/locallang_db.xml:tx_exabiscompetences_desp_lang',		
		'label'     => 'title',	
		'tstamp'    => 'tstamp',
		'crdate'    => 'crdate',
		'cruser_id' => 'cruser_id',
...
t3lib_extMgm::addPlugin(array(
	'LLL:EXT:exabis_competences/locallang_db.xml:tt_content.list_type_pi1',
	$_EXTKEY . '_pi1',
